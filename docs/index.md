...
![Metro Stad logo](assets/main_inverted.png){ .hero-logo loading=lazy }

<span class="landing-kicker">Praktisch, doorzoekbaar en altijd actueel.</span>

# Alles wat je in Metro Stad snel moet kunnen vinden
...
<div class="metric-strip">
  <div class="metric">
    <strong>1 bron</strong>
    Regels, kaarten en platforminformatie zonder te zoeken in losse Discord-berichten.
  </div>
  <div class="metric">
    <strong>Snel scannen</strong>
    Hoofdcategorieen, tags en zoekfunctie voor desktop en mobiel.
  </div>
  <div class="metric">
    <strong>Live updates</strong>
    Belangrijke wijzigingen worden eerst hier bijgewerkt en daarna gedeeld in Discord.
  </div>
</div>
...
<div class="link-grid">
  ...
  <a class="link-card" href="/belastingen/">
    ...
    <span class="link-card__cta">Bekijk belastingen</span>
  </a>
</div>
...
<div class="link-grid">
  ...
  <a class="link-card" href="/tags/">
    ...
    <span class="link-card__cta">Open onderwerpen</span>
  </a>
</div>
...
<div class="link-grid">
  <a class="link-card link-card--featured" href="https://discord.gg/metrostad">
    <span class="link-card__kicker">Discord</span>
    <h3 class="link-card__title">Algemene Discord</h3>
    <p class="link-card__copy">Main Discord van Metro Stad voor updates, community en aankondigingen.</p>
    <span class="link-card__cta">Open invite</span>
  </a>
  <a class="link-card" href="https://discord.gg/TpsvX56XnQ">
    <span class="link-card__kicker">Support</span>
    <h3 class="link-card__title">Support Discord</h3>
    <p class="link-card__copy">Voor vragen, tickets, bezwaren en technische ondersteuning.</p>
    <span class="link-card__cta">Open support</span>
  </a>
  <a class="link-card" href="https://discord.gg/TQ6996MzRr">
    <span class="link-card__kicker">Onderwereld</span>
    <h3 class="link-card__title">Onderwereld Discord</h3>
    <p class="link-card__copy">Updates en communicatie rond onderwereldgerelateerde zaken.</p>
    <span class="link-card__cta">Open onderwereld</span>
  </a>
  <a class="link-card" href="https://discord.gg/BexmHeGxyN">
    <span class="link-card__kicker">Luchtvaart</span>
    <h3 class="link-card__title">Vliegschool Discord</h3>
    <p class="link-card__copy">Voor vliegbrevetten, luchtvaartvragen en bijbehorende community.</p>
    <span class="link-card__cta">Open vliegschool</span>
  </a>
</div>

!!! info "Levend document"
    De documentatie wordt doorlopend bijgewerkt. Kom regelmatig terug of gebruik de zoekfunctie en tags om nieuwe onderwerpen sneller te vinden.
