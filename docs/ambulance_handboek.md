...
Het ambulancehandboek is opgesplitst in compacte hoofdstukken, zodat medewerkers sneller de juiste werkwijze of bevoegdheid kunnen vinden tijdens een inzet.
...
!!! info "Meest gebruikt tijdens dienst"
    - Zoek je **statuscodes, porto of meldkamergebruik**? Open [Communicatie & Meldkamer](ambulance/communicatie-en-meldkamer.md).
    - Zoek je **reanimeren, wondzorg of shockprotocol**? Open [Medische Protocollen](ambulance/medische-protocollen.md).
    - Zoek je **sirenes, bevoegdheden of beroepsgeheim**? Open [Wetgeving & Bevoegdheden](ambulance/wetgeving-en-bevoegdheden.md).
    - Zoek je **GRIP, triage of trainingen**? Open [GRIP & Training](ambulance/grip-en-training.md).

## Kernprincipes

| Onderwerp | Kernpunt |
|:--|:--|
| Professionaliteit | Handel accuraat, rustig en volgens protocol. |
| Veiligheid | Eigen veiligheid, patiëntveiligheid en scene safety gaan voor snelheid. |
| Samenwerking | Werk strak samen met meldkamer, politie, brandweer en andere medische eenheden. |
| Verantwoordelijkheid | Werk binnen je rang, rapporteer fouten en schaal op wanneer nodig. |

!!! note "Gebruik van dit handboek"
    Dit handboek is bedoeld als operationele leidraad. Bij twijfel tijdens een inzet is de hoogst bevoegde aanwezige leidinggevende of meldkamerinstructie leidend.
