...
| Onderdeel | Frequentie | Waarop gebaseerd | Mogelijk gevolg bij wanbetaling |
|:--|:--|:--|:--|
| Voertuigenbelasting | Wekelijks | Type voertuig | Inbeslagname of ontoegankelijk voertuig |
| Huizenbelasting | Iedere zaterdag | Woning of pand | Tijdelijke afsluiting of ontruiming |

## Voertuigenbelasting

Voor elk voertuig dat je bezit in Metro Stad betaal je een bijdrage. Dit helpt om wegen te onderhouden, parkeerplaatsen te verbeteren en verkeersveiligheid te verhogen.

!!! info "Voertuigenbelasting"
    Voor elk voertuig dat je bezit, wordt wekelijks voertuigenbelasting geind. De hoogte hiervan hangt af van het type voertuig.

!!! warning "Niet-betaalde voertuigenbelasting"
...
!!! note "Voertuigreferentie"
    Een extern overzicht van modelnamen vind je op de [RAGE Multiplayer Wiki](https://wiki.rage.mp/wiki/Vehicles).

### Tarieven per categorie

=== "Straat & prestaties"

    | Categorie | Bedrag per week |
    |:--|--:|
    | Compacte voertuigen | €250 |
    | Motoren | €300 |
    | Sedans | €350 |
    | Servicevoertuigen | €400 |
    | SUV's | €500 |
    | Busjes | €500 |
    | Coupes | €600 |
    | Muscle cars | €600 |
...
=== "Zakelijk & utiliteit"
    ...
    |:--|--:|
    | Aanhangers | €200 |
    | Commerciele voertuigen | €800 |
    | Boten | €1.000 |
    | Industriele voertuigen | €1.500 |
...
### Modeloverzicht per categorie

=== "Straat & prestaties"

    ??? info "Compacte voertuigen · €250 per week"
        `asbo`, `blista`, `brioso`, `club`, `dilettante`, `kanjo`, `issi`, `panto`, `prairie`, `rhapsody`, `weevil`

    ??? info "Motoren · €300 per week"
    ...
    ??? info "Servicevoertuigen · €400 per week"
        `airbus`, `bus`, `coach`, `rentalbus`, `taxi`, `tourbus`, `trash`

    ??? info "SUV's · €500 per week"
    ...
    ??? info "Terreinwagens · €700 per week"
    ...
    ??? info "Sportwagens · €1.000 per week"
    ...
    ??? info "Klassieke sportwagens · €1.250 per week"
...
!!! warning "Niet-betaalde huizenbelasting"
